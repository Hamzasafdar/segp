...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="displaygroups.php"><svg class="glyph stroked star"><use xlink:href="#stroked-star"></use></svg> Display Group</a></li>
		</ul>
		</ul>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<div class="RackList">
							...
							$gp=$_POST['group'];
							$ye=$_SESSION['sal'];
								$sql = "SELECT * FROM student_data WHERE year = '$ye' AND groupno=$gp";
								$result = $conn->query($sql);
