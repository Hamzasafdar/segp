...
$id=$_REQUEST['id'];
$query_select="SELECT * FROM student_data WHERE id='".$id."' LIMIT 1";
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Namal</span>Colleges</a>
				<ul class="user-menu">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<form method="post" action="edit_record_process.php"  enctype="multipart/form-data">
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
							<div class="panel-body">
								<div class="form-group has-success">
									...
									<input type="text" class="form-control" style="width: 40%" placeholder="Father Name" name="fname" value="<?=$row_select['f_name']?>"><br>

									<label>UOB</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="UOB" name="uob" value="<?=$row_select['uob']?>"><br>

									<label>CNIC</label>
									<input type="text" class="form-control" style="width: 40%" placeholder="CNIC" name="cnic" value="<?=$row_select['cnic']?>"><br>

									<label>Department</label>
									<select class="form-control" name="department" value="<?=$row_select['department']?>"  style="width: 40%">
										<!-- <option disabled selected><?=$row_select['department']?></option> -->
									...
									<select class="form-control" name="year" style="width: 40%">
										<!-- <option disabled selected><?=$row_select['year']?></option> -->
										<option>1</option>
										<option>2</option>
										<option>3</option>
										<option>4</option>
									...
									<label>Upload</label>
									<input type="file" class="form-control"  name="image" style="width: 40%">
